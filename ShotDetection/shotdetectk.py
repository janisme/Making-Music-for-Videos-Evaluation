...
if __name__ == '__main__':
    ...
    parser.add_argument('--end_time',    type=float, default=None, help="float: timecode")
    parser.add_argument('--begin_frame', type=int,   default=None,  help="int: frame")
    parser.add_argument('--end_frame',   type=int,   default=None,  help="int: frame")
